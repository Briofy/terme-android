...
public class MonthPagerAdapter extends PagerAdapter {
    ...
    private LyCalendarData lyCalendarData;
    private DateSelectListener listener;
    private ArrayList tags = new ArrayList();
    private final String TAG_PREFIX = "SLY_CAL_TAG";

    MonthPagerAdapter(LyCalendarData lyCalendarData, DateSelectListener listener) {
        this.lyCalendarData = lyCalendarData;
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        final GridAdapter adapter = new GridAdapter(container.getContext(), lyCalendarData, indexShift, listener, new GridChangeListener() {
            @Override
        ...
        currentDate.setTime(lyCalendarData.getShowDate());
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 2 : 1);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 3 : 2);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 4 : 3);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 5 : 4);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 6 : 5);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 7 : 6);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, lyCalendarData.isFirstMonday() ? 1 : 7);
