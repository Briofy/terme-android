package net.terme.offical.navbar
...
import net.terme.offical.navbar.type.LyNavBarAction
import net.terme.offical.navbar.type.LyNavBarType
import net.terme.offical.navbar.type.SearchLinksUserIm
import net.terme.offical.navbar.type.cta.CTAButtonIm
import net.terme.offical.navbar.type.dropdown.DoubleDropdownIm
import net.terme.offical.navbar.type.level.BottomLevelIm
import net.terme.offical.navbar.type.level.three.ThreeLevelIm
import net.terme.offical.navbar.type.level.top.TopLevelIm
import net.terme.offical.navbar.type.links.LinksUserIm
import net.terme.offical.navbar.type.simple.SimpleMegaMenu

typealias ButtonCallback = () -> Unit
typealias MenuCallback = () -> Unit

class TermeNavBar : LinearLayoutCompat {
