...
class TimelineDecorator(
    val indicatorStyle: TermeTimelineView.IndicatorStyle = TermeTimelineView.IndicatorStyle.Filled,
    ...
    val lineStyle: TermeTimelineView.LineStyle? = null,
    ...
    override fun getItemOffsets(
        ...
        val size = when(indicatorStyle){
            TermeTimelineView.IndicatorStyle.Filled -> width
            TermeTimelineView.IndicatorStyle.Empty -> width + checkedIndicatorStrokeWidth
            TermeTimelineView.IndicatorStyle.Checked -> width + checkedIndicatorStrokeWidth
        }.toInt()
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        (parent.adapter as? TimelineAdapter).let { adapter ->
            parent.children.forEach {
                ...
                val timelineView = TermeTimelineView(context = parent.context)
