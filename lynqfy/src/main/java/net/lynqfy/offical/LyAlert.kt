...
import net.lynqfy.offical.base.BaseAlert
import net.lynqfy.offical.base.LyView
import net.lynqfy.offical.databinding.LyLayoutBinding
...
class LyAlert private constructor() : BaseAlert<LyLayoutBinding>(
    ...
    private fun initDialog() {
        viewBinding.apply {
            ...
            this@LyAlert.isCancelable = cancelable
    ...
    private fun onClick() {
        viewBinding.apply {
            ...
            btn.onClickListener = object : LyView.OnClickListener {
