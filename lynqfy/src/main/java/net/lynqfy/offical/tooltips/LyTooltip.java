package net.lynqfy.offical.tooltips;
...
public class LyTooltip {

    private View rootView;
    private final View view;
    private final TooltipView tooltip_view;

    private LyTooltip(MyContext myContext, View view) {
        this.view = view;
    ...
    private LyTooltip(MyContext myContext, View rootView, View view) {
    ...
    private LyTooltip(View view) {
        this(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static LyTooltip on(final View view) {
        return new LyTooltip(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static LyTooltip on(Fragment fragment, final View view) {
        return new LyTooltip(new MyContext(fragment), view);
    }

    public static LyTooltip on(Activity activity, final View view) {
        return new LyTooltip(new MyContext(getActivityContext(activity)), view);
    }

    public static LyTooltip on(Activity activity, final View rootView, final View view) {
        return new LyTooltip(new MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public LyTooltip position(Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public LyTooltip withShadow(boolean withShadow) {
        this.tooltip_view.setWithShadow(withShadow);
        return this;
    }

    public LyTooltip shadowColor(@ColorInt int shadowColor) {
        this.tooltip_view.setShadowColor(shadowColor);
        return this;
    }

    public LyTooltip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public LyTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public LyTooltip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public LyTooltip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public LyTooltip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public LyTooltip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public LyTooltip align(ALIGN align) {
    ...
    public LyTooltip duration(long duration) {
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public LyTooltip titleColor(int color) {
        this.tooltip_view.setTitleColor(color);
        return this;
    }

    public LyTooltip color(int color) {
        this.tooltip_view.setColor(color);
        return this;
    }

    public LyTooltip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public LyTooltip onDisplay(ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public LyTooltip onHide(ListenerHide listener) {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public LyTooltip padding(int left, int top, int right, int bottom) {
    ...
    public LyTooltip animation(TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public LyTooltip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public LyTooltip title(@StringRes int text) {
        this.tooltip_view.setTitle(text);
        return this;
    }

    public LyTooltip title(String text) {
        this.tooltip_view.setTitle(text);
        return this;
    }

    public LyTooltip text(@StringRes int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public LyTooltip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public LyTooltip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public LyTooltip textTypeFace(Typeface typeface) {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public LyTooltip textSize(int unit, float textSize) {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public LyTooltip margin(int left, int top, int right, int bottom) {
        this.tooltip_view.setMargin(left, top, right, bottom);
        return this;
    }

    public LyTooltip setTextGravity(int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public LyTooltip clickToHide(boolean clickToHide) {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public LyTooltip autoHide(boolean autoHide, long duration) {
        this.tooltip_view.setAutoHide(autoHide);
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public LyTooltip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public LyTooltip border(int color, float width) {
    ...
    public static class TooltipView extends LinearLayoutCompat {
        ...
        public TooltipView(Context context) {
            ...
            addView(titleView, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            ...
            setShadowColor(context.getResources().getColor(R.color.ly_card_shadow ,null));
            setColor(context.getResources().getColor(R.color.ly_card_background, null));
            setTitleColor(context.getResources().getColor(R.color.ly_card_title, null));
            setTextColor(context.getResources().getColor(R.color.ly_card_content, null));
