package net.terme.offical.tooltips;
...
public class TermeTooltip {

    private View rootView;
    private final View view;
    private final TooltipView tooltip_view;

    private TermeTooltip(MyContext myContext, View view) {
        this.view = view;
    ...
    private TermeTooltip(MyContext myContext, View rootView, View view) {
    ...
    private TermeTooltip(View view) {
        this(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static TermeTooltip on(final View view) {
        return new TermeTooltip(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static TermeTooltip on(Fragment fragment, final View view) {
        return new TermeTooltip(new MyContext(fragment), view);
    }

    public static TermeTooltip on(Activity activity, final View view) {
        return new TermeTooltip(new MyContext(getActivityContext(activity)), view);
    }

    public static TermeTooltip on(Activity activity, final View rootView, final View view) {
        return new TermeTooltip(new MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public TermeTooltip position(Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public TermeTooltip withShadow(boolean withShadow) {
        this.tooltip_view.setWithShadow(withShadow);
        return this;
    }

    public TermeTooltip shadowColor(@ColorInt int shadowColor) {
        this.tooltip_view.setShadowColor(shadowColor);
        return this;
    }

    public TermeTooltip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public TermeTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public TermeTooltip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public TermeTooltip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public TermeTooltip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public TermeTooltip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public TermeTooltip align(ALIGN align) {
    ...
    public TermeTooltip duration(long duration) {
    ...
    public TermeTooltip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public TermeTooltip onDisplay(ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public TermeTooltip onHide(ListenerHide listener) {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public TermeTooltip padding(int left, int top, int right, int bottom) {
    ...
    public TermeTooltip animation(TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public TermeTooltip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public TermeTooltip title(@StringRes int text) {
        this.tooltip_view.setTitle(text);
        return this;
    }

    public TermeTooltip title(String text) {
        this.tooltip_view.setTitle(text);
        return this;
    }

    public TermeTooltip text(@StringRes int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public TermeTooltip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public TermeTooltip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public TermeTooltip textTypeFace(Typeface typeface) {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public TermeTooltip textSize(int unit, float textSize) {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public TermeTooltip margin(int left, int top, int right, int bottom) {
        this.tooltip_view.setMargin(left, top, right, bottom);
        return this;
    }

    public TermeTooltip setTextGravity(int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public TermeTooltip clickToHide(boolean clickToHide) {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public TermeTooltip autoHide(boolean autoHide, long duration) {
        this.tooltip_view.setAutoHide(autoHide);
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public TermeTooltip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public TermeTooltip border(int color, float width) {
