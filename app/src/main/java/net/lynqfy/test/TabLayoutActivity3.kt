...
class TabLayoutActivity3 : AppCompatActivity(), OnTabSelectListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /** 默认 */
        /** 默认  */
        val tabLayout_1: SlidingLyTabLayout = findViewById(R.id.tl_1)
        val tabLayout_2: SlidingLyTabLayout = findViewById(R.id.tl_2)

        val tabLayout_3: SlidingLyTabLayout = findViewById(R.id.tl_3)

        val tabLayout_4: SlidingLyTabLayout = findViewById(R.id.tl_4)

        val tabLayout_5: SlidingLyTabLayout = findViewById(R.id.tl_5)

        val tabLayout_6: SlidingLyTabLayout = findViewById(R.id.tl_6)

        val tabLayout_7: SlidingLyTabLayout = findViewById(R.id.tl_7)

        val tabLayout_8: SlidingLyTabLayout = findViewById(R.id.tl_8)

        val tabLayout_9: SlidingLyTabLayout = findViewById(R.id.tl_9)

        val tabLayout_10: SlidingLyTabLayout = findViewById(R.id.tl_10)
