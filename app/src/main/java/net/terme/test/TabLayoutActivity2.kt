...
import net.terme.offical.tablayout.TermeTabLayoutSegment
...
class TabLayoutActivity2 : AppCompatActivity() {
    ...
    private lateinit var mTabLayout_3: TermeTabLayoutSegment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tabLayout_1: TermeTabLayoutSegment = findViewById(R.id.tl_1)
        val tabLayout_2: TermeTabLayoutSegment = findViewById(R.id.tl_2)
        mTabLayout_3 = findViewById(R.id.tl_3)
        val tabLayout_4: TermeTabLayoutSegment = findViewById(R.id.tl_4)
        val tabLayout_5: TermeTabLayoutSegment = findViewById(R.id.tl_5)
