...
import net.lynqfy.offical.databinding.LyNavBarThreeLevelUiBinding
...
class ThreeLevelIm(
    ...
    override var type: LyNavBarType = LyNavBarType.ThreeLevels
) : ThreeLevel{
    ...
    private val ui by lazy {
        LyNavBarThreeLevelUiBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    }
}