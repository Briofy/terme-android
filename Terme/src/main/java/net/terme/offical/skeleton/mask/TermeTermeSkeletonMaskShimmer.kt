...
import net.terme.offical.base.isAttachedToWindowCompat
import net.terme.offical.base.refreshRateInSeconds
...
internal class TermeTermeSkeletonMaskShimmer(
    ...
    private fun currentOffset(): Float {
        val progress = when (shimmerDirection) {
            TermeSkeletonShimmerDirection.LEFT_TO_RIGHT -> currentProgress()
            TermeSkeletonShimmerDirection.RIGHT_TO_LEFT -> 1 - currentProgress()
        }
        val offset = width * 2
        val min = -offset
