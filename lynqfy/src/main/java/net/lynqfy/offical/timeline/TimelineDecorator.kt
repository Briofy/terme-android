...
class TimelineDecorator(
    val indicatorStyle: LyTimelineView.IndicatorStyle = LyTimelineView.IndicatorStyle.Filled,
    ...
    val lineStyle: LyTimelineView.LineStyle? = null,
    ...
    override fun getItemOffsets(
        ...
        val size = when(indicatorStyle){
            LyTimelineView.IndicatorStyle.Filled -> width
            LyTimelineView.IndicatorStyle.Empty -> width + checkedIndicatorStrokeWidth
            LyTimelineView.IndicatorStyle.Checked -> width + checkedIndicatorStrokeWidth
        }.toInt()
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        (parent.adapter as? TimelineAdapter).let { adapter ->
            parent.children.forEach {
                ...
                val timelineView = LyTimelineView(context = parent.context)
