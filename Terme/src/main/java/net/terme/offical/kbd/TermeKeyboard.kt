...
class TermeKeyboard : MaterialCardView {
        ...
        attrs?.also { att ->
            ...
            if (attributes.getValue(R.styleable.TermeKeyboard_keyType, keyType)) {
                when (keyType.data) {
                    ...
                    /*"text"*/  else -> {
                    attributes.getString(R.styleable.TermeKeyboard_keyText)?.let {
                        mTextView.text = it
                    }
                    addView(mTextView)
                }
            ...
            attributes.getColor(R.styleable.TermeKeyboard_android_keyBackground, mBackgroundColor)
                .let {
                    setCardBackgroundColor(it)
                }

            attributes.getColor(R.styleable.TermeKeyboard_android_keyTextColor, mTextColor).let {
    ...
    private var mBackgroundColor = resources.getColor(R.color.terme_card_background, null)
    private var mTextColor = resources.getColor(R.color.terme_card_title, null)
}