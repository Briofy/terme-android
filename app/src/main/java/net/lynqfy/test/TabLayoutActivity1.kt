...
class TabLayoutActivity1 : AppCompatActivity() {
    ...
    private lateinit var mTabLayout_7: CommonLyTabLayout
    private lateinit var mTabLayout_1: CommonLyTabLayout
    private lateinit var mTabLayout_2: CommonLyTabLayout
    private lateinit var mTabLayout_3: CommonLyTabLayout
    private lateinit var mTabLayout_4: CommonLyTabLayout
    private lateinit var mTabLayout_5: CommonLyTabLayout
    private lateinit var mTabLayout_6: CommonLyTabLayout
    private lateinit var mTabLayout_8: CommonLyTabLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rtv_2_2: LyTextView? = mTabLayout_2.getLyTextView(2)
        if (rtv_2_2 != null) {
        ...
        val rtv_2_3: LyTextView? = mTabLayout_2.getLyTextView(3)
        if (rtv_2_3 != null) {
