...
//
//public class LyTimelineView extends View {
//
//    public static final String TAG = LyTimelineView.class.getSimpleName();
//
...
//
//    public LyTimelineView(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        init(attrs);
//    }
//
...
//        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.LyTimelineView);
//        mMarker = typedArray.getDrawable(R.styleable.LyTimelineView_marker);
//        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_markerSize, Utils.dpToPx(20, getContext()));
//        mMarkerPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_markerPaddingLeft, 0);
//        mMarkerPaddingTop = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_markerPaddingTop, 0);
//        mMarkerPaddingRight = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_markerPaddingRight, 0);
//        mMarkerPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_markerPaddingBottom, 0);
//        mMarkerInCenter = typedArray.getBoolean(R.styleable.LyTimelineView_markerInCenter, true);
//        mStartLineColor = typedArray.getColor(R.styleable.LyTimelineView_startLineColor, getColor(android.R.color.darker_gray));
//        mEndLineColor = typedArray.getColor(R.styleable.LyTimelineView_endLineColor, getColor(android.R.color.darker_gray));
//        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_lineWidth, Utils.dpToPx(2, getContext()));
//        mLineOrientation = typedArray.getInt(R.styleable.LyTimelineView_lineOrientation, LineOrientation.VERTICAL);
//        mLinePadding = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_linePadding, 0);
//        mLineStyle = typedArray.getInt(R.styleable.LyTimelineView_lineStyle, LineStyle.NORMAL);
//        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_lineStyleDashLength, Utils.dpToPx(8f, getContext()));
//        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.LyTimelineView_lineStyleDashGap, Utils.dpToPx(4f, getContext()));
//        typedArray.recycle();
//
//        if (isInEditMode()) {
//            mDrawStartLine = true;
...
//
//        if (mMarker == null) {
//            mMarker = ResourcesCompat.getDrawable(getResources(), R.drawable.marker, null);
//        }
//
//        initTimeline();
//        initLinePaint();
...
//    }
//
//    public void setMarker(@DrawableRes int drawableResId) {
//        mMarker = VectorDrawableUtils.INSTANCE.getDrawable(getContext(), drawableResId);
//        initTimeline();
//    }
//
//    /**
