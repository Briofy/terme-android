...
import net.terme.offical.AlertType
import net.terme.offical.LyAlert
...
class AlertActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val message = findViewById<TermeButton>(R.id.ly_message)
        val info = findViewById<TermeButton>(R.id.ly_info)
        val error = findViewById<TermeButton>(R.id.ly_error)
        val success = findViewById<TermeButton>(R.id.ly_success)
        val warning = findViewById<TermeButton>(R.id.ly_warning)

        message.onClickListener = object : TermeView.OnClickListener {
            override fun onButtonClick(button: View) {
                val alert = LyAlert.Builder(this@AlertActivity)
                    ...
                    .setIconRes(net.terme.offical.R.drawable.ic_alert_icon)
                    .setCancelable(true)
        ...
        info.onClickListener = object : TermeView.OnClickListener {
            override fun onButtonClick(button: View) {
                val alert = LyAlert.Builder(this@AlertActivity)
        ...
        error.onClickListener = object : TermeView.OnClickListener {
            override fun onButtonClick(button: View) {
                val alert = LyAlert.Builder(this@AlertActivity)
        ...
        success.onClickListener = object : TermeView.OnClickListener {
            override fun onButtonClick(button: View) {
                val alert = LyAlert.Builder(this@AlertActivity)
        ...
        warning.onClickListener = object : TermeView.OnClickListener {
            override fun onButtonClick(button: View) {
                val alert = LyAlert.Builder(this@AlertActivity)
